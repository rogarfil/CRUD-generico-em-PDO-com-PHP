    ...
    public static function getInstance(): PDO
    {
        ...
        if (!isset(self::$pdo)) {
            try {
                ...
                switch (SGBD):
                    case 'mysql':
                        self::$pdo = new PDO("mysql:host=" . HOST . "; port=" . PORT . "; dbname=" . DBNAME . ";",
                    ...
                    case 'mssql':
                        if (SERVER == 'linux'):
                             ...
                             * DNS PDO para Linux
                             */
                            self::$pdo = new PDO("dblib:host=" . HOST . "; port=" . PORT . "; dbname=" . DBNAME . ";",
                                USER, PASSWORD, $options);
                        else:
                            /**
                             * DNS PDO para Windows
                             */
                            self::$pdo = new PDO("sqlsrv:host=" . HOST . "; port=" . PORT . "; dbname=" . DBNAME . ";",
                                USER, PASSWORD, $options);
                        endif;
                        break;
                    case 'postgre':
                        self::$pdo = new PDO("pgsql:host=" . HOST . "; port=" . PORT . "; dbname=" . DBNAME . ";",
                            USER, PASSWORD, $options);
                        break;
                    case 'sqlite':
                        self::$pdo = new PDO("sqlite:host=" . HOST . "; port=" . PORT . "; dbname=" . DBNAME . ";",
                            USER, PASSWORD, $options);
                        /**
                        ...
                        break;
                    case 'oci8':
                        self::$pdo = new PDO("oci:host=" . HOST . "; port=" . PORT . "; dbname=" . DBNAME . ";",
                            USER, PASSWORD, $options);
                        break;
                    case 'firebird':
                        self::$pdo = new PDO("firebird:host=" . HOST . "; port=" . PORT . "; dbname=" . DBNAME . ";",
                            USER, PASSWORD, $options);
                        break;
                endswitch;
